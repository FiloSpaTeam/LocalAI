...
export const agentsApi = {
  ...
  chat: (name, message, conversationId, userId) => postJSON(`/api/agents/${enc(name)}/chat${userQ(userId)}`, { message, conversation_id: conversationId }),
  answer: (name, body, userId) => postJSON(`/api/agents/${enc(name)}/answer${userQ(userId)}`, body),
  decidePlan: (name, body, userId) => postJSON(`/api/agents/${enc(name)}/plan${userQ(userId)}`, body),
  pending: (name, conversationId, userId) => fetchJSON(buildUrl(`/api/agents/${enc(name)}/pending`, {
