		...
		return c.JSON(200, map[string]any{
			...
			"endpoint_groups": map[string]any{
				...
				"agents": map[string]string{
					...
					"list":                 "/api/agents",
					"config_metadata":      "/api/agents/config/metadata",
					"chat":                 "/api/agents/:name/chat",
					"answer_question":      "/api/agents/:name/answer",
					"decide_plan":          "/api/agents/:name/plan",
					"pending_interactions": "/api/agents/:name/pending",
					"events":               "/api/agents/:name/sse",
				},
