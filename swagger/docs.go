        ...
        "/api/agents/{name}/answer": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Target user ID (admin or agent worker only)",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/localai.AgentAnswerRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/localai.AgentInteractionStatus"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/localai.AgentChatRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/agentpool.ChatReceipt"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/agents/{name}/jobs/{job_id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Job ID returned by chat",
                        "name": "job_id",
                        "in": "path",
                        "required": true
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/localai.AgentPlanDecisionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "jobs.ChatJob": {
            ...
            "properties": {
                ...
                "error": {
                    "$ref": "#/definitions/jobs.ChatJobError"
                },
                "expires_at": {
                    "type": "string"
                },
        ...
        "localai.AgentInteractionStatus": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
        ...
        "localai.AgentPlanDecisionRequest": {
            "type": "object",
            "properties": {
                "approved": {
                    "type": "boolean"
